# ===== VARIABLES =====
# Variables between the AUTOGENERATED tags are set when running the `init`
...
rename-package :
	...
	sed -i "" "s/src.competition_name/src.$(FORMATTED_COMPETITION_NAME)/g" configure_makefile.py
...
reset-package-name :
	...
	sed -i "" -r "s/src\.[^.]+\./src.competition_name./g" configure_makefile.py
